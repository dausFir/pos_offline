...
export default function Dashboard() {
  ...
  const cards = [
    ...
    { label: t('dash.today_profit'),       value: formatRupiah(stats?.today_profit || 0),  sub: 'Omset - HPP hari ini', icon: 'trending_up', color: 'var(--secondary)', bg: 'var(--secondary-container)' },
  ...
  return (
    <div className="rapipos-dashboard">
      {/* Header */}
      <div className="page-header">
        <div>
          <p className="rapipos-page-kicker">OVERVIEW / DASHBOARD</p>
          <h2 className="page-title">Ringkasan usaha</h2>
        ...
        <div className="card" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: 'var(--on-surface-variant)' }}>
                <span style={{ width: 10, height: 10, borderRadius: 2, background: 'var(--secondary)', display: 'inline-block' }} /> Laba
              </span>
            </div>
          </div>
